    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            switch(op){
                ...
                case 3:
                    System.out.println("\n*****REPORTE*****");
                    if (lista.isEmpty()) {   //Lista tiene tamaño = o entonces "lista.isEmpty()" true 
                        System.out.println("No hay clientes registrados."); //muestra mensaje
                    } else {   //Si tiene clientes entra en for 
                        for(Cliente cli : lista) {
                            cli.mostrar();
                        }
                    }
